...
<div class=\"container\">
    <section class=\"content\">
        ...
        <article class=\"flexy-grid\">
            ...
            <label id=\"h3_1\" style=\"display: none;margin-top: -20px;\" class=\"value-label\">点击进入</label>
        </article>
    </section>
    <div style=\"position:fixed; height:50px;width:100%;bottom:0px;\">
        <center>代刷管家©感谢以下技术支持</center>
        <center><a href=\"http://vps.ambitzs.cn/\">AM云</a>，<a href=\"http://zeink.cn/\" >ZEINK</a></center>
    </div>
</div>
<!-- /container -->
