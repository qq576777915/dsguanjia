            ...
            <div id="navbar" class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="<?php echo checkIfActive('classlist,shoplist,kmlist') ?>">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span
                                    class="glyphicon glyphicon glyphicon-shopping-cart"></span> 商品管理<b
                                    class="caret"></b></a>
                        <ul class="dropdown-menu">
                    ...
                    <li class="<?php echo checkIfActive('fakalist,fakakms') ?>">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span
                                    class="glyphicon glyphicon-th"></span> 发卡管理<b class="caret"></b></a>
                        <ul class="dropdown-menu">
                    ...
                    <li class="<?php echo checkIfActive('sitelist,tixian,record') ?>">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span
                                    class="glyphicon glyphicon-globe"></span> 分站管理<b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="./tixian.php">余额提现</a>
                            <li><?php } ?>
                        </ul>
                    </li>
                    <li class="<?php echo checkIfActive('set,shequlist') ?>">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span
                                    class="glyphicon glyphicon-cog"></span> 系统设置<b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li><a href="./set.php?mod=site">网站信息配置</a></li>
                            <li><a href="./set.php?mod=gonggao">网站公告配置</a></li>
                            <li><a href="./shequlist.php">社区/卡盟对接配置</a>
                            <li>
                            <li><a href="./set.php?mod=mail">发信邮箱配置</a>
                            <li>
                            <li><a href="./set.php?mod=pay">支付接口配置</a>
                            <li>
                            <li><a href="./set.php?mod=template">首页模板设置</a>
                            <li>
                            <li><a href="./set.php?mod=upimg">网站Logo上传</a>
                            <li>
                            <li><a href="./clean.php">系统数据清理</a>
                            <li>
                            <li><a href="./update.php">检查版本更新</a>
                            <li>
                        </ul>
                    </li>
